...
import view.hud.HealthView;
import view.hud.IHudElement;
import view.hud.PowerupSlotView;
import view.hud.ScoreboardView;
import view.hud.TimerView;
import view.maps.IGameWorld;
import view.effects.AirCallIndicator;
import view.gameEntity.CanonBallEntity;
import view.gameEntity.LandmineEntity;
import view.gameEntity.MissileEntity;
import view.gameEntity.NapalmEntity;
import view.gameEntity.PowerupEntity;
import view.gameEntity.TankEntity;
...
import controller.gameManagers.GameAppState;
import controller.gameManagers.ViewPortManager;
...
public final class TanksFactory {
    ...
    public static GameAppState getNewGame(Class<? extends IGameWorld> worldMapClass, Collection<String> playerNames) {
        ...
        GameSettings settings = new GameSettings(300000, 10, 5000);
